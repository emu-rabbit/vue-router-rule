import{_ as a,p as n,q as s,a1 as e}from"./framework-5866ffd3.js";const t={},o=e(`<h1 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h1><p>Here&#39;s the guide for a very simple package setup</p><h2 id="install-package" tabindex="-1"><a class="header-anchor" href="#install-package" aria-hidden="true">#</a> Install package</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i vue-router-rule
...
<span class="token function">defineRule</span><span class="token punctuation">(</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">)</span>
</code></pre></div><h2 id="import-into-main-js" tabindex="-1"><a class="header-anchor" href="#import-into-main-js" aria-hidden="true">#</a> Import into main.js</h2><p>Import it to your project entry script<br> For example <code>@/main.js</code></p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// Must import after your Vue Router created</span>
